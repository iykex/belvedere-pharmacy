...
const SISTER_BRANCHES = [
  {
    ...
    url: "https://belvederepharmacy.co.uk/book",
    current: true,
  },
  {
    name: "Kidbrooke Pharmacy",
    slug: "kidbrooke",
    address: "134 Rochester Way, London, SE3 8AR",
    phone: "020 8319 0115",
    hours: "Mon - Fri: 09:00 - 18:00",
    url: "https://kidbrookepharmacy.com/book",
    current: false,
  },
  {
    name: "Lowfield Pharmacy",
    slug: "lowfield",
    address: "63 Lowfield Street, Dartford, Kent, DA1 1HP",
    phone: "01322 220779",
    hours: "Mon - Fri: 09:00 - 18:00",
    url: "https://lowfieldpharmacy.co.uk/book",
    current: false,
  },
];
...
export default function BookingHubContent() {
  ...
  const privateBookingUrl =
    tenant?.privateBookingUrl || "https://www.phdr.co.uk/2483";
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-bold text-foreground">
                  Current Branch: {tenant?.displayName ?? "Belvedere Pharmacy"}
                </h2>
              ...
              <div className="flex flex-wrap gap-4 text-xs sm:text-sm text-muted-foreground">
                <span className="flex items-center gap-1">
                  ...
                  {tenant?.address?.line1 ?? "11 Picardy Street"},{" "}
                  {tenant?.address?.postcode ?? "DA17 5QQ"}
                </span>
                <span className="flex items-center gap-1">
                  <Phone className="size-3.5 text-primary" />
                  <a
                    href={`tel:${tenant?.phone ?? "02083114087"}`}
                    className="hover:text-primary font-medium underline"
                  >
                    {tenant?.phone ?? "020 8311 4087"}
                  </a>
                </span>
                <span className="flex items-center gap-1">
