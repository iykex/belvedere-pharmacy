          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="text-primary hover:bg-primary hover:border-background hover:text-primary-foreground font-semibold px-8 rounded-full transition-all duration-300 group"
              >
