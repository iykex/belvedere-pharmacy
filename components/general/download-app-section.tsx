...
export default function DownloadAppSection() {
  return (
    <WidthConstraint className="grid gap-12 md:grid-cols-2 items-center bg-linear-to-br from-accent/50 via-background to-secondary/30 rounded-3xl p-8 md:p-12 lg:p-16 border border-border shadow-lg overflow-hidden relative">
      ...
      <div className="relative h-[400px] lg:h-[600px] flex scale-70 md:scale-100 items-center justify-center">
        ...
        <div className="relative z-10 w-[280px] h-[560px] bg-linear-to-br from-foreground to-foreground/80 rounded-[3rem] shadow-2xl border-8 border-foreground/20 overflow-hidden">
