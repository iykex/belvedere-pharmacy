...
export default function Banner() {
  ...
  return (
    <div
      ...
      ref={animationScope}
    >
      <div className="w-full h-full bg-linear-to-r from-[#002f4b] from-2% flex items-center text-white overflow-hidden">
        <WidthConstraint className="mt-20 sm:mt-0">
          <Badge
            id="NHS-badge"
            variant="secondary"
            className="mb-4 sm:mb-8 p-2 text-sm md:text-base font-bold bg-[#00BFFF] text-[#002f4b] hover:bg-[#00BFFF]/90 border-0 px-4"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-5 mt-6 sm:mt-12 sm:px-0">
            <Button
              id="menu-outline-btn"
              variant="outline"
              className="flex bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#002f4b] w-fit sm:h-16 sm:px-10 rounded-full sm:text-xl font-bold transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            >
              <Link
            ...
            <Button
              id="menu-solid-btn"
              className="flex items-center justify-center bg-[#FF9900] text-white hover:bg-[#FF9900]/90 sm:h-16 sm:px-10 w-fit rounded-full sm:text-xl font-bold transition-all duration-300 shadow-xl hover:shadow-orange-500/30 hover:-translate-y-1 group border-2 border-[#FF9900]"
            >
              <Link
          ...
          <div id="info-badges" className=" mt-10 sm:mt-20 flex flex-wrap gap-5">
