...
export const metadata: Metadata = {
  title: "Book Pharmacy Services & Clinical Appointments | Belvedere Pharmacy",
  description:
    "Schedule private vaccinations, NHS Pharmacy First consultations, and clinical services at Belvedere Pharmacy, 11 Picardy Street, Belvedere. Accredited PharmaDoctor portal & NHS walk-in guidance.",
  alternates: {
    canonical: "/book",
  },
};
