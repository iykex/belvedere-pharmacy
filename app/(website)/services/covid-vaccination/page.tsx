...
export const metadata: Metadata = {
  title: "COVID-19 Seasonal Booster Vaccination | Belvedere Pharmacy",
  description:
    "Official NHS COVID-19 booster vaccinations at Belvedere Pharmacy, 11 Picardy Street, Belvedere. Protecting seniors aged 65+, vulnerable individuals, and carers. Accredited NHS vaccination clinic.",
  alternates: {
  ...
  faqs: [
    {
      ...
      answer:
        "You can book through the NHS National Booking Service (NBS), call NHS 119, or walk into Belvedere Pharmacy directly during our vaccination clinic hours.",
    },
    {
...
export default function CovidVaccinationPage() {
  const jsonLd = {
    ...
    description:
      "NHS COVID-19 seasonal booster immunisation clinic at Belvedere Pharmacy.",
    ...
    provider: {
      ...
      address: {
        "@type": "PostalAddress",
        streetAddress: "11 Picardy Street",
        addressLocality: "Belvedere",
        addressRegion: "Kent",
        postalCode: "DA17 5QQ",
        addressCountry: "GB",
      },
      telephone: "+442083114087",
    },
  };
