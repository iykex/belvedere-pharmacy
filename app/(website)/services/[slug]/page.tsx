...
export async function generateMetadata({
  ...
  return {
    title: `${readableTitle} | Clinical Services | Belvedere Pharmacy`,
    description: `Professional healthcare service for ${readableTitle} at Belvedere Pharmacy, 11 Picardy Street, Belvedere. Fast consultation and accredited clinical care.`,
    alternates: {
    ...
    <div className="overflow-hidden space-y-12 sm:space-y-20 pb-30 pt-24 sm:pt-28">
      ...
      <main>
        <ClinicalServiceTemplate
          ...
          subtitle={`Clinical healthcare service provided by registered pharmacists at Belvedere Pharmacy.`}
          category="both"
