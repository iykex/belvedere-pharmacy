...
export const metadata: Metadata = {
  title: "Seasonal Flu Vaccination Clinic (NHS Free & Private) | Belvedere Pharmacy",
  description:
    "Get your seasonal influenza jab at Belvedere Pharmacy, 11 Picardy Street, Belvedere. Free NHS flu vaccinations for eligible cohorts and private walk-in flu jabs. Accredited clinical immunisation service.",
  alternates: {
...
export default function FluVaccinationPage() {
  const jsonLd = {
    ...
    description:
      "Seasonal flu jab administration service at Belvedere Pharmacy for NHS eligible and private patients.",
