...
export const metadata: Metadata = {
  title: "Our Community Pharmacies | Belvedere, Kidbrooke & Lowfield",
  description:
    "Explore our accredited NHS community pharmacies across Kent and South East London: Belvedere Pharmacy, Kidbrooke Pharmacy, and Lowfield Pharmacy. Opening hours, contact details, and clinical services.",
  alternates: {
